...
# Project showcase description for parents and visitors
with st.expander("🎓 About This Student Project"):
    st.markdown("""
    This **AI-powered Invoice Extractor** is a student-developed project that demonstrates how cutting-edge technology can solve real-world problems. 
    Built using **Google’s Gemini AI** and a sleek **Streamlit interface**, it processes invoices in multiple languages—even handwritten ones—and accurately extracts all critical information.

    ### 🔍 Key Capabilities:
    - ✅ Intelligent **keyword extraction** (invoice number, dates, buyer/seller details, etc.)
    - 🧠 Precise **layout detection** to retain document structure
    - 📋 Accurate **table extraction** with proper markdown formatting
    - 🌐 Supports **multilingual** and **handwritten** invoices
    - 🎯 Ideal for industries like **finance, logistics, retail, and e-commerce**

    This project reflects the **future-ready skills** our students are building—combining AI, programming, and problem-solving to create impactful solutions.
    """)
